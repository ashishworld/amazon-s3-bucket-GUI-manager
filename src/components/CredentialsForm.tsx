      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          >
            ...
            <option value="ap-east-1">Asia (Hong Kong) - ap-east-1</option>
            <option value="ap-south-1">Asia (Mumbai) - ap-south-1</option>
            <option value="ap-south-2">Asia (Hyderabad) - ap-south-2</option>
            <option value="ap-southeast-1">Asia (Singapore) - ap-southeast-1</option>
            <option value="ap-southeast-2">Asia (Sydney) - ap-southeast-2</option>
            <option value="ap-southeast-3">Asia (Jakarta) - ap-southeast-3</option>
            <option value="ap-southeast-4">Asia (Melbourne) - ap-southeast-4</option>
            <option value="ap-northeast-1">Asia (Tokyo) - ap-northeast-1</option>
            <option value="ap-northeast-2">Asia (Seoul) - ap-northeast-2</option>
            <option value="ap-northeast-3">Asia (Osaka) - ap-northeast-3</option>
